...
$query = '';
$output = array();
$query .= "SELECT chambre.*,hotel.libelle as hotel, categorie.libelle as categorie from hotel,chambre,categorie where chambre.hotel = hotel.id and categorie.id = chambre.categorie ";
